...
function NosComites() {
    ...
    <div className="bg-white">
        <Navbar />
        <Socials />
    <div className="container mx-auto px-6 py-4 mt-4"> {/* Ajout de margin-top pour décaler */}
    ...
    <div>
        ...
        <p>
        Le Comité de l’Hémovigilance a pour mission de contribuer par ses études et ses propositions à l’amélioration de la sécurité des patients qui y sont transfusés. Il veille à la mise en oeuvre des règles et procédures d’hémovigilance prévues par la présente section. Il est notamment chargé de la coordination des actions d’hémovigilance entreprises au sein du CHU. Il a tenu sa première réunion préparatoire le 07 Août 2015.        </p>
    </div>
    </div>
    </div>
    </div>
